...
func main() {
	...
	// Test v2 frame (Envelope wrapping Frame with EchoArenaFrame payload)
...
func createV2Frame(playerCount int) *telemetryv2.Frame {
	gameFrame := &telemetryv2.EchoArenaFrame{
	...
	for i := 0; i < playerCount; i++ {
		gameFrame.Players[i] = &telemetryv2.PlayerState{
			Slot: int32(i),
			Head: &spatial.Pose{
