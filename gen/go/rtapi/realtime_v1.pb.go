...
const file_rtapi_realtime_v1_proto_rawDesc = "" +
	"\n" +
	"\x17rtapi/realtime_v1.proto\x12\brealtime\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18rtapi/telemetry_v1.proto\"\xf7&\n" +
	"\bEnvelope\x12\x10\n" +
	"\x03cid\x18\x01 \x01(\tR\x03cid\x12'\n" +
	"\x05error\x18\x02 \x01(\v2\x0f.realtime.ErrorH\x00R\x05error\x12T\n" +
	"\x13lobby_session_state\x18\x03 \x01(\v2\".realtime.LobbySessionStateMessageH\x00R\x11lobbySessionState\x12b\n" +
	"\x17connectivity_statistics\x18\x04 \x01(\v2'.realtime.ConnectivityStatisticsMessageH\x00R\x16connectivityStatistics\x12c\n" +
	"\x18game_server_registration\x18\x05 \x01(\v2'.realtime.GameServerRegistrationMessageH\x00R\x16gameServerRegistration\x12y\n" +
	" game_server_registration_success\x18\x06 \x01(\v2..realtime.GameServerRegistrationSuccessMessageH\x00R\x1dgameServerRegistrationSuccess\x12W\n" +
	"\x14lobby_session_create\x18\a \x01(\v2#.realtime.LobbySessionCreateMessageH\x00R\x12lobbySessionCreate\x12T\n" +
	"\x13lobby_session_event\x18\b \x01(\v2\".realtime.LobbySessionEventMessageH\x00R\x11lobbySessionEvent\x12a\n" +
	"\x17lobby_entrant_connected\x18\t \x01(\v2'.realtime.LobbyEntrantsConnectedMessageH\x00R\x15lobbyEntrantConnected\x12X\n" +
	"\x14lobby_entrant_accept\x18\n" +
	" \x01(\v2$.realtime.LobbyEntrantsAcceptMessageH\x00R\x12lobbyEntrantAccept\x12X\n" +
	"\x14lobby_entrant_reject\x18\v \x01(\v2$.realtime.LobbyEntrantsRejectMessageH\x00R\x12lobbyEntrantReject\x12X\n" +
	"\x14lobby_entrant_remove\x18\f \x01(\v2$.realtime.LobbyEntrantRemovedMessageH\x00R\x12lobbyEntrantRemove\x12F\n" +
	"\x0funknown_message\x18\r \x01(\v2\x1b.realtime.SNSUnknownMessageH\x00R\x0eunknownMessage\x12g\n" +
	"\x1ctcp_connection_require_event\x18\x0e \x01(\v2$.realtime.STCPConnectionRequireEventH\x00R\x19tcpConnectionRequireEvent\x12m\n" +
	"\x1etcp_connection_unrequire_event\x18\x0f \x01(\v2&.realtime.STCPConnectionUnrequireEventH\x00R\x1btcpConnectionUnrequireEvent\x12Q\n" +
	"\x11config_request_v2\x18\x10 \x01(\v2#.realtime.SNSConfigRequestV2MessageH\x00R\x0fconfigRequestV2\x12Q\n" +
	"\x11config_success_v2\x18\x11 \x01(\v2#.realtime.SNSConfigSuccessV2MessageH\x00R\x0fconfigSuccessV2\x12Q\n" +
	"\x11config_failure_v2\x18\x12 \x01(\v2#.realtime.SNSConfigFailureV2MessageH\x00R\x0fconfigFailureV2\x12G\n" +
	"\rreconcile_iap\x18\x13 \x01(\v2 .realtime.SNSReconcileIAPMessageH\x00R\freconcileIap\x12Z\n" +
	"\x14channel_info_request\x18\x14 \x01(\v2&.realtime.SNSChannelInfoRequestMessageH\x00R\x12channelInfoRequest\x12]\n" +
	"\x15channel_info_response\x18\x15 \x01(\v2'.realtime.SNSChannelInfoResponseMessageH\x00R\x13channelInfoResponse\x12W\n" +
	"\x13document_request_v2\x18\x16 \x01(\v2%.realtime.SNSDocumentRequestV2MessageH\x00R\x11documentRequestV2\x12P\n" +
	"\x10document_success\x18\x17 \x01(\v2#.realtime.SNSDocumentSuccessMessageH\x00R\x0fdocumentSuccess\x12P\n" +
	"\x10document_failure\x18\x18 \x01(\v2#.realtime.SNSDocumentFailureMessageH\x00R\x0fdocumentFailure\x12w\n" +
	"\x1flobby_create_session_request_v9\x18\x19 \x01(\v2/.realtime.SNSLobbyCreateSessionRequestV9MessageH\x00R\x1blobbyCreateSessionRequestV9\x12t\n" +
	"\x1elobby_find_session_request_v11\x18\x1a \x01(\v2..realtime.SNSLobbyFindSessionRequestv11MessageH\x00R\x1alobbyFindSessionRequestV11\x12q\n" +
	"\x1dlobby_join_session_request_v7\x18\x1b \x01(\v2-.realtime.SNSLobbyJoinSessionRequestV7MessageH\x00R\x19lobbyJoinSessionRequestV7\x12c\n" +
	"\x17lobby_matchmaker_status\x18\x1c \x01(\v2).realtime.SNSLobbyMatchmakerStatusMessageH\x00R\x15lobbyMatchmakerStatus\x12y\n" +
	"\x1flobby_matchmaker_status_request\x18\x1d \x01(\v20.realtime.SNSLobbyMatchmakerStatusRequestMessageH\x00R\x1clobbyMatchmakerStatusRequest\x12w\n" +
	"\x1flobby_pending_session_cancel_v2\x18\x1e \x01(\v2/.realtime.SNSLobbyPendingSessionCancelV2MessageH\x00R\x1blobbyPendingSessionCancelV2\x12[\n" +
	"\x15lobby_ping_request_v3\x18\x1f \x01(\v2&.realtime.SNSLobbyPingRequestV3MessageH\x00R\x12lobbyPingRequestV3\x12W\n" +
	"\x13lobby_ping_response\x18  \x01(\v2%.realtime.SNSLobbyPingResponseMessageH\x00R\x11lobbyPingResponse\x12z\n" +
	" lobby_player_sessions_request_v5\x18! \x01(\v20.realtime.SNSLobbyPlayerSessionsRequestV5MessageH\x00R\x1clobbyPlayerSessionsRequestV5\x12d\n" +
	"\x18lobby_session_failure_v4\x18\" \x01(\v2).realtime.SNSLobbySessionFailureV4MessageH\x00R\x15lobbySessionFailureV4\x12d\n" +
	"\x18lobby_session_success_v5\x18# \x01(\v2).realtime.SNSLobbySessionSuccessV5MessageH\x00R\x15lobbySessionSuccessV5\x12t\n" +
	"\x1elogged_in_user_profile_failure\x18$ \x01(\v2..realtime.SNSLoggedInUserProfileFailureMessageH\x00R\x1aloggedInUserProfileFailure\x12t\n" +
	"\x1elogged_in_user_profile_request\x18% \x01(\v2..realtime.SNSLoggedInUserProfileRequestMessageH\x00R\x1aloggedInUserProfileRequest\x12t\n" +
	"\x1elogged_in_user_profile_success\x18& \x01(\v2..realtime.SNSLoggedInUserProfileSuccessMessageH\x00R\x1aloggedInUserProfileSuccess\x12H\n" +
	"\x0elog_in_failure\x18' \x01(\v2 .realtime.SNSLogInFailureMessageH\x00R\flogInFailure\x12O\n" +
	"\x11log_in_request_v2\x18( \x01(\v2\".realtime.SNSLogInRequestV2MessageH\x00R\x0elogInRequestV2\x12J\n" +
	"\x0elogin_settings\x18) \x01(\v2!.realtime.SNSLoginSettingsMessageH\x00R\rloginSettings\x12H\n" +
	"\x0elog_in_success\x18* \x01(\v2 .realtime.SNSLogInSuccessMessageH\x00R\flogInSuccess\x12j\n" +
	"\x1aother_user_profile_failure\x18+ \x01(\v2+.realtime.SNSOtherUserProfileFailureMessageH\x00R\x17otherUserProfileFailure\x12j\n" +
	"\x1aother_user_profile_request\x18, \x01(\v2+.realtime.SNSOtherUserProfileRequestMessageH\x00R\x17otherUserProfileRequest\x12j\n" +
	"\x1aother_user_profile_success\x18- \x01(\v2+.realtime.SNSOtherUserProfileSuccessMessageH\x00R\x17otherUserProfileSuccess\x12Z\n" +
	"\x14reconcile_iap_result\x18. \x01(\v2&.realtime.SNSReconcileIAPResultMessageH\x00R\x12reconcileIapResult\x12O\n" +
	"\x11remote_log_set_v3\x18/ \x01(\v2\".realtime.SNSRemoteLogSetV3MessageH\x00R\x0eremoteLogSetV3\x12J\n" +
	"\x0eupdate_profile\x180 \x01(\v2!.realtime.SNSUpdateProfileMessageH\x00R\rupdateProfile\x12`\n" +
	...
	"\x04type\x18\x01 \x01(\v2\x14.realtime.SymbolHashR\x04type\x12\x12\n" +
	...
	"\x04type\x18\x01 \x01(\v2\x14.realtime.SymbolHashR\x04type\x12$\n" +
	"\x02id\x18\x02 \x01(\v2\x14.realtime.SymbolHashR\x02id\x12\x12\n" +
	...
	"\auser_id\x18\x02 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\"\x1e\n" +
	...
	"\x06region\x18\x01 \x01(\v2\x14.realtime.SymbolHashR\x06region\x127\n" +
	"\fversion_lock\x18\x02 \x01(\v2\x14.realtime.SymbolHashR\vversionLock\x12(\n" +
	"\x04mode\x18\x03 \x01(\v2\x14.realtime.SymbolHashR\x04mode\x12*\n" +
	"\x05level\x18\x04 \x01(\v2\x14.realtime.SymbolHashR\x05level\x120\n" +
	"\bplatform\x18\x05 \x01(\v2\x14.realtime.SymbolHashR\bplatform\x12(\n" +
	"\x10login_session_id\x18\x06 \x01(\tR\x0eloginSessionId\x121\n" +
	"\bentrants\x18\a \x03(\v2\x15.realtime.XPlatformIDR\bentrants\x12)\n" +
	"\x10session_settings\x18\b \x01(\tR\x0fsessionSettings\"\xb4\x03\n" +
	"$SNSLobbyFindSessionRequestv11Message\x127\n" +
	"\fversion_lock\x18\x01 \x01(\v2\x14.realtime.SymbolHashR\vversionLock\x12(\n" +
	"\x04mode\x18\x02 \x01(\v2\x14.realtime.SymbolHashR\x04mode\x12*\n" +
	"\x05level\x18\x03 \x01(\v2\x14.realtime.SymbolHashR\x05level\x120\n" +
	"\bplatform\x18\x04 \x01(\v2\x14.realtime.SymbolHashR\bplatform\x12(\n" +
	...
	"\bentrants\x18\t \x03(\v2\x15.realtime.XPlatformIDR\bentrants\"\xeb\x01\n" +
	"#SNSLobbyJoinSessionRequestV7Message\x12\x19\n" +
	"\blobby_id\x18\x01 \x01(\tR\alobbyId\x127\n" +
	"\fversion_lock\x18\x02 \x01(\v2\x14.realtime.SymbolHashR\vversionLock\x120\n" +
	"\bplatform\x18\x03 \x01(\v2\x14.realtime.SymbolHashR\bplatform\x12(\n" +
	...
	"\auser_id\x18\x02 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\x12\x19\n" +
	"\blobby_id\x18\x03 \x01(\tR\alobbyId\x120\n" +
	"\bplatform\x18\x04 \x01(\v2\x14.realtime.SymbolHashR\bplatform\x128\n" +
	"\fplayer_xpids\x18\x05 \x03(\v2\x15.realtime.XPlatformIDR\vplayerXpids\"Z\n" +
	...
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12.\n" +
	"\auser_id\x18\x02 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\x120\n" +
	"\x14profile_request_data\x18\x03 \x01(\tR\x12profileRequestData\"p\n" +
	"$SNSLoggedInUserProfileSuccessMessage\x12.\n" +
	"\auser_id\x18\x01 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\x12\x18\n" +
	...
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12.\n" +
	"\auser_id\x18\x02 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\"\x8e\x01\n" +
	...
	"\auser_id\x18\x01 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\x12\x12\n" +
	...
	"\auser_id\x18\x01 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\x12\x19\n" +
	...
	"\auser_id\x18\x01 \x01(\v2\x15.realtime.XPlatformIDR\x06userId\"\x8b\x01\n" +
	...
	"\auser_id\x18\x01 \x01(\v2\x15.realtime.XPlatformIDR\x06userIdBs\n" +
	"\x1fcom.github.echotools.nevr.rtapiB\fNevrRealtimeP\x01Z0github.com/echotools/nevr-common/v4/gen/go/rtapi\xaa\x02\rNevr.Protobufb\x06proto3"
...
var file_rtapi_realtime_v1_proto_goTypes = []any{
	...
	(LobbyEntrantsRejectMessage_Code)(0),             // 2: realtime.LobbyEntrantsRejectMessage.Code
	(LobbyEntrantRemovedMessage_Code)(0),             // 3: realtime.LobbyEntrantRemovedMessage.Code
	(LobbySessionCreateMessage_LobbyType)(0),         // 4: realtime.LobbySessionCreateMessage.LobbyType
	(*Envelope)(nil),                                 // 5: realtime.Envelope
	(*Error)(nil),                                    // 6: realtime.Error
...
var file_rtapi_realtime_v1_proto_depIdxs = []int32{
	...
	11, // 8: realtime.Envelope.lobby_entrant_accept:type_name -> realtime.LobbyEntrantsAcceptMessage
	12, // 9: realtime.Envelope.lobby_entrant_reject:type_name -> realtime.LobbyEntrantsRejectMessage
	13, // 10: realtime.Envelope.lobby_entrant_remove:type_name -> realtime.LobbyEntrantRemovedMessage
