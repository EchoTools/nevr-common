...
const file_rtapi_realtime_v1_proto_rawDesc = "" +
	...
	"\x17lobby_entrant_connected\x18\t \x01(\v2'.realtime.LobbyEntrantsConnectedMessageH\x00R\x15lobbyEntrantConnected\x12Z\n" +
	"\x15lobby_entrants_accept\x18\n" +
	" \x01(\v2$.realtime.LobbyEntrantsAcceptMessageH\x00R\x13lobbyEntrantsAccept\x12X\n" +
	"\x14lobby_entrant_reject\x18\v \x01(\v2$.realtime.LobbyEntrantsRejectMessageH\x00R\x12lobbyEntrantReject\x12Z\n" +
	"\x15lobby_entrant_removed\x18\f \x01(\v2$.realtime.LobbyEntrantRemovedMessageH\x00R\x13lobbyEntrantRemoved\x12F\n" +
