...
const file_rtapi_realtime_v1_proto_rawDesc = "" +
	...
	"\x13lobby_session_event\x18\b \x01(\v2*.nevr.realtime.v1.LobbySessionEventMessageH\x00R\x11lobbySessionEvent\x12e\n" +
	"\x15lobby_entra_connected\x18\t \x01(\v2/.nevr.realtime.v1.LobbyEntrantsConnectedMessageH\x00R\x13lobbyEntraConnected\x12`\n" +
...
var file_rtapi_realtime_v1_proto_depIdxs = []int32{
	...
	10, // 7: nevr.realtime.v1.Envelope.lobby_entra_connected:type_name -> nevr.realtime.v1.LobbyEntrantsConnectedMessage
	...
	61, // 53: nevr.realtime.v1.LobbySessionStateRawMessage.timestamp:type_name -> google.protobuf.Timestamp
	18, // 54: nevr.realtime.v1.SNSUnknownMessage.type:type_name -> nevr.realtime.v1.SymbolHash
	18, // 55: nevr.realtime.v1.SNSConfigSuccessV2Message.type:type_name -> nevr.realtime.v1.SymbolHash
	18, // 56: nevr.realtime.v1.SNSConfigSuccessV2Message.id:type_name -> nevr.realtime.v1.SymbolHash
	19, // 57: nevr.realtime.v1.SNSReconcileIAPMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	18, // 58: nevr.realtime.v1.SNSLobbyCreateSessionRequestV9Message.region:type_name -> nevr.realtime.v1.SymbolHash
	18, // 59: nevr.realtime.v1.SNSLobbyCreateSessionRequestV9Message.version_lock:type_name -> nevr.realtime.v1.SymbolHash
	18, // 60: nevr.realtime.v1.SNSLobbyCreateSessionRequestV9Message.mode:type_name -> nevr.realtime.v1.SymbolHash
	18, // 61: nevr.realtime.v1.SNSLobbyCreateSessionRequestV9Message.level:type_name -> nevr.realtime.v1.SymbolHash
	18, // 62: nevr.realtime.v1.SNSLobbyCreateSessionRequestV9Message.platform:type_name -> nevr.realtime.v1.SymbolHash
	19, // 63: nevr.realtime.v1.SNSLobbyCreateSessionRequestV9Message.entrants:type_name -> nevr.realtime.v1.XPlatformID
	18, // 64: nevr.realtime.v1.SNSLobbyFindSessionRequestv11Message.version_lock:type_name -> nevr.realtime.v1.SymbolHash
	18, // 65: nevr.realtime.v1.SNSLobbyFindSessionRequestv11Message.mode:type_name -> nevr.realtime.v1.SymbolHash
	18, // 66: nevr.realtime.v1.SNSLobbyFindSessionRequestv11Message.level:type_name -> nevr.realtime.v1.SymbolHash
	18, // 67: nevr.realtime.v1.SNSLobbyFindSessionRequestv11Message.platform:type_name -> nevr.realtime.v1.SymbolHash
	19, // 68: nevr.realtime.v1.SNSLobbyFindSessionRequestv11Message.entrants:type_name -> nevr.realtime.v1.XPlatformID
	18, // 69: nevr.realtime.v1.SNSLobbyJoinSessionRequestV7Message.version_lock:type_name -> nevr.realtime.v1.SymbolHash
	18, // 70: nevr.realtime.v1.SNSLobbyJoinSessionRequestV7Message.platform:type_name -> nevr.realtime.v1.SymbolHash
	19, // 71: nevr.realtime.v1.SNSLobbyPlayerSessionsRequestV5Message.user_id:type_name -> nevr.realtime.v1.XPlatformID
	18, // 72: nevr.realtime.v1.SNSLobbyPlayerSessionsRequestV5Message.platform:type_name -> nevr.realtime.v1.SymbolHash
	19, // 73: nevr.realtime.v1.SNSLobbyPlayerSessionsRequestV5Message.player_xpids:type_name -> nevr.realtime.v1.XPlatformID
	19, // 74: nevr.realtime.v1.SNSLoggedInUserProfileFailureMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 75: nevr.realtime.v1.SNSLoggedInUserProfileRequestMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 76: nevr.realtime.v1.SNSLoggedInUserProfileSuccessMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 77: nevr.realtime.v1.SNSLogInFailureMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 78: nevr.realtime.v1.SNSLogInRequestV2Message.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 79: nevr.realtime.v1.SNSLogInSuccessMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 80: nevr.realtime.v1.SNSOtherUserProfileFailureMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 81: nevr.realtime.v1.SNSOtherUserProfileRequestMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 82: nevr.realtime.v1.SNSOtherUserProfileSuccessMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 83: nevr.realtime.v1.SNSReconcileIAPResultMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 84: nevr.realtime.v1.SNSRemoteLogSetV3Message.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 85: nevr.realtime.v1.SNSUpdateProfileMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 86: nevr.realtime.v1.SNSUpdateProfileSuccessMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 87: nevr.realtime.v1.SNSUpdateProfileFailureMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 88: nevr.realtime.v1.SNSUserServerProfileUpdateRequestMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
	19, // 89: nevr.realtime.v1.SNSUserServerProfileUpdateSuccessMessage.user_id:type_name -> nevr.realtime.v1.XPlatformID
