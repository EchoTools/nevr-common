...
func (x *PlayerShotTaken) Reset() {
	*x = PlayerShotTaken{}
	mi := &file_rtapi_telemetry_v1_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PlayerShotTaken) Descriptor() ([]byte, []int) {
	return file_rtapi_telemetry_v1_proto_rawDescGZIP(), []int{25}
}
...
const file_rtapi_telemetry_v1_proto_rawDesc = "" +
	"\n" +
	"\x18rtapi/telemetry_v1.proto\x12\ttelemetry\x1a\x15apigame/http_v1.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xee\x01\n" +
	...
	"\x06events\x18\x03 \x03(\v2\x1c.telemetry.LobbySessionEventR\x06events\x125\n" +
	"\asession\x18\x04 \x01(\v2\x1b.enginehttp.SessionResponseR\asession\x12B\n" +
	"\fplayer_bones\x18\x05 \x01(\v2\x1f.enginehttp.PlayerBonesResponseR\vplayerBones\"\xb7\v\n" +
	...
	"\x11player_shot_taken\x189 \x01(\v2\x1a.telemetry.PlayerShotTakenH\x00R\x0fplayerShotTakenB\a\n" +
	"\x05event\"1\n" +
	"\fRoundStarted\x12!\n" +
	...
	"\vplayer_slot\x18\x01 \x01(\x05R\n" +
	"playerSlot\x12#\n" +
	"\rprevious_slot\x18\x02 \x01(\x05R\fpreviousSlot\"m\n" +
	"\n" +
	"DiscThrown\x12\x1f\n" +
	"\vplayer_slot\x18\x01 \x01(\x05R\n" +
	"playerSlot\x12>\n" +
	...
	"\tMODERATOR\x10\x05Bw\n" +
	"\x18com.echotools.nevr.rtapiB\rNevrTelemetryP\x01Z0github.com/echotools/nevr-common/v4/gen/go/rtapi\xaa\x02\x17Nevr.Telemetry.Protobufb\x06proto3"
...
var file_rtapi_telemetry_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_rtapi_telemetry_v1_proto_goTypes = []any{
	...
	(*PlayerGoal)(nil),                  // 19: telemetry.PlayerGoal
	(*PlayerSave)(nil),                  // 20: telemetry.PlayerSave
	(*PlayerStun)(nil),                  // 21: telemetry.PlayerStun
	(*PlayerPass)(nil),                  // 22: telemetry.PlayerPass
	(*PlayerSteal)(nil),                 // 23: telemetry.PlayerSteal
	(*PlayerBlock)(nil),                 // 24: telemetry.PlayerBlock
	(*PlayerInterception)(nil),          // 25: telemetry.PlayerInterception
	(*PlayerAssist)(nil),                // 26: telemetry.PlayerAssist
	(*PlayerShotTaken)(nil),             // 27: telemetry.PlayerShotTaken
	nil,                                 // 28: telemetry.TelemetryHeader.MetadataEntry
	(*timestamppb.Timestamp)(nil),       // 29: google.protobuf.Timestamp
	(*apigame.SessionResponse)(nil),     // 30: enginehttp.SessionResponse
	(*apigame.PlayerBonesResponse)(nil), // 31: enginehttp.PlayerBonesResponse
	(*apigame.PauseState)(nil),          // 32: enginehttp.PauseState
	(*apigame.TeamMember)(nil),          // 33: enginehttp.TeamMember
	(*apigame.LastThrowInfo)(nil),       // 34: enginehttp.LastThrowInfo
	(*apigame.LastScore)(nil),           // 35: enginehttp.LastScore
}
var file_rtapi_telemetry_v1_proto_depIdxs = []int32{
	29, // 0: telemetry.TelemetryHeader.created_at:type_name -> google.protobuf.Timestamp
	28, // 1: telemetry.TelemetryHeader.metadata:type_name -> telemetry.TelemetryHeader.MetadataEntry
	29, // 2: telemetry.LobbySessionStateFrame.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 3: telemetry.LobbySessionStateFrame.events:type_name -> telemetry.LobbySessionEvent
	30, // 4: telemetry.LobbySessionStateFrame.session:type_name -> enginehttp.SessionResponse
	31, // 5: telemetry.LobbySessionStateFrame.player_bones:type_name -> enginehttp.PlayerBonesResponse
	...
	20, // 20: telemetry.LobbySessionEvent.player_save:type_name -> telemetry.PlayerSave
	21, // 21: telemetry.LobbySessionEvent.player_stun:type_name -> telemetry.PlayerStun
	22, // 22: telemetry.LobbySessionEvent.player_pass:type_name -> telemetry.PlayerPass
	23, // 23: telemetry.LobbySessionEvent.player_steal:type_name -> telemetry.PlayerSteal
	24, // 24: telemetry.LobbySessionEvent.player_block:type_name -> telemetry.PlayerBlock
	25, // 25: telemetry.LobbySessionEvent.player_interception:type_name -> telemetry.PlayerInterception
	26, // 26: telemetry.LobbySessionEvent.player_assist:type_name -> telemetry.PlayerAssist
	27, // 27: telemetry.LobbySessionEvent.player_shot_taken:type_name -> telemetry.PlayerShotTaken
	32, // 28: telemetry.RoundPaused.pause_state:type_name -> enginehttp.PauseState
	32, // 29: telemetry.RoundUnpaused.pause_state:type_name -> enginehttp.PauseState
	...
	33, // 32: telemetry.PlayerJoined.player:type_name -> enginehttp.TeamMember
	...
	34, // 36: telemetry.DiscThrown.throw_details:type_name -> enginehttp.LastThrowInfo
	35, // 37: telemetry.GoalScored.score_details:type_name -> enginehttp.LastScore
