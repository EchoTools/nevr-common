...
func (c *nevrServiceClient) ListGuildGameServers(ctx context.Context, in *api.ListGuildGameServersRequest, opts ...grpc.CallOption) (*api.GuildGameServerList, error) {
...
func RegisterNevrServiceServer(s grpc.ServiceRegistrar, srv NevrServiceServer) {
	// If the following call pancis, it indicates UnimplementedNevrServiceServer was
...
func _NevrService_ListGuildGameServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NevrServiceServer).ListGuildGameServers(ctx, req.(*api.ListGuildGameServersRequest))
	}
