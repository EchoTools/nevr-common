...
const file_apigame_http_v1_proto_rawDesc = "" +
	...
	"\x04head\x18\x05 \x01(\v2\x14.enginehttp.BodyPartR\x04head\x12(\n" +
	"\x04body\x18\x06 \x01(\v2\x14.enginehttp.BodyPartR\x04body\x12\x1e\n" +
	...
	"possession\x12.\n" +
	"\tleft_hand\x18\x15 \x01(\v2\x14.enginehttp.HandPartR\x05lhand\x12/\n" +
	"\n" +
	"right_hand\x18\x16 \x01(\v2\x14.enginehttp.HandPartR\x05rhand\x12\x1a\n" +
	"\bvelocity\x18\x17 \x03(\x01R\bvelocity\x12-\n" +
	"\x05stats\x18\x18 \x01(\v2\x17.enginehttp.PlayerStatsR\x05stats\"\xd3\x02\n" +
	"\tTeamStats\x12(\n" +
	"\x0fpossession_time\x18\x01 \x01(\x01R\x0fpossession_time\x12\x16\n" +
	"\x06points\x18\x02 \x01(\x05R\x06points\x12\x14\n" +
	"\x05saves\x18\x03 \x01(\x05R\x05saves\x12\x14\n" +
	...
	"\x04Team\x120\n" +
	"\aplayers\x18\x01 \x03(\v2\x16.enginehttp.TeamMemberR\aplayers\x12\x17\n" +
	"\tteam_name\x18\x02 \x01(\tR\x04team\x12\"\n" +
	"\x0ehas_possession\x18\x03 \x01(\bR\n" +
	"possession\x12+\n" +
	"\x05stats\x18\x04 \x01(\v2\x15.enginehttp.TeamStatsR\x05stats\"\xf7\x01\n" +
	"\tLastScore\x12\x1e\n" +
	"\n" +
	...
	"\x04disc\x18\b \x01(\v2\x10.enginehttp.DiscR\x04disc\x12*\n" +
	...
	"\n" +
	"last_throw\x18\x14 \x01(\v2\x19.enginehttp.LastThrowInfoR\n" +
	"last_throw\x12.\n" +
	"\x06player\x18\x15 \x01(\v2\x16.enginehttp.PlayerRootR\x06player\x12,\n" +
	"\x05pause\x18\x16 \x01(\v2\x16.enginehttp.PauseStateR\x05pause\x12\x1e\n" +
	"\n" +
	...
	"\n" +
	"last_score\x18\x1f \x01(\v2\x15.enginehttp.LastScoreR\n" +
	"last_score\x12&\n" +
	"\x05teams\x18  \x03(\v2\x10.enginehttp.TeamR\x05teams\x12.\n" +
	...
	"\n" +
	"user_bones\x18\x01 \x03(\v2\x15.enginehttp.UserBonesR\n" +
	"user_bones\x12\x1a\n" +
	"\berr_code\x18\x02 \x01(\x05R\berr_code2\xc8\x01\n" +
	"\x11EngineHttpService\x12S\n" +
	"\n" +
	"GetSession\x12\x16.google.protobuf.Empty\x1a\x1b.enginehttp.SessionResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/session\x12^\n" +
	"\x0eGetPlayerBones\x12\x16.google.protobuf.Empty\x1a\x1f.enginehttp.PlayerBonesResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/user_bonesB\x87\x01\n" +
...
var file_apigame_http_v1_proto_goTypes = []any{
	...
	(*PlayerStats)(nil),         // 3: enginehttp.PlayerStats
	(*TeamMember)(nil),          // 4: enginehttp.TeamMember
	(*TeamStats)(nil),           // 5: enginehttp.TeamStats
	(*Team)(nil),                // 6: enginehttp.Team
	(*LastScore)(nil),           // 7: enginehttp.LastScore
	(*LastThrowInfo)(nil),       // 8: enginehttp.LastThrowInfo
	(*PauseState)(nil),          // 9: enginehttp.PauseState
	(*PlayerRoot)(nil),          // 10: enginehttp.PlayerRoot
	(*SessionResponse)(nil),     // 11: enginehttp.SessionResponse
	(*UserBones)(nil),           // 12: enginehttp.UserBones
...
var file_apigame_http_v1_proto_depIdxs = []int32{
	...
	2,  // 3: enginehttp.TeamMember.right_hand:type_name -> enginehttp.HandPart
	3,  // 4: enginehttp.TeamMember.stats:type_name -> enginehttp.PlayerStats
	4,  // 5: enginehttp.Team.players:type_name -> enginehttp.TeamMember
	5,  // 6: enginehttp.Team.stats:type_name -> enginehttp.TeamStats
	0,  // 7: enginehttp.SessionResponse.disc:type_name -> enginehttp.Disc
	8,  // 8: enginehttp.SessionResponse.last_throw:type_name -> enginehttp.LastThrowInfo
	10, // 9: enginehttp.SessionResponse.player:type_name -> enginehttp.PlayerRoot
	9,  // 10: enginehttp.SessionResponse.pause:type_name -> enginehttp.PauseState
	7,  // 11: enginehttp.SessionResponse.last_score:type_name -> enginehttp.LastScore
	6,  // 12: enginehttp.SessionResponse.teams:type_name -> enginehttp.Team
	12, // 13: enginehttp.PlayerBonesResponse.user_bones:type_name -> enginehttp.UserBones
	14, // 14: enginehttp.EngineHttpService.GetSession:input_type -> google.protobuf.Empty
	14, // 15: enginehttp.EngineHttpService.GetPlayerBones:input_type -> google.protobuf.Empty
	11, // 16: enginehttp.EngineHttpService.GetSession:output_type -> enginehttp.SessionResponse
	13, // 17: enginehttp.EngineHttpService.GetPlayerBones:output_type -> enginehttp.PlayerBonesResponse
