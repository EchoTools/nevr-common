...
func MessageTypeHash(msg EasyStreamer) uint64 {
	...
	case *TCPConnectionUnrequireEvent:
...
func NewMessageFromHash(hash uint64) EasyStreamer {
	...
	case 0x43e6963ac76beee4:
		return &TCPConnectionUnrequireEvent{}
