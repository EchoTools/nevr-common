...
func (m *LobbySessionFailure) String() string {
	return fmt.Sprintf("%T(game_type=%d, channel=%s, error_code=%d, unk0=%d, msg=%s)", m, m.GameTypeSymbol, m.ChannelUUID.String(), m.ErrorCode, m.Unk0, m.Message)
}
...
func (m *LobbySessionFailurev1) String() string {
	return fmt.Sprintf("%T(error_code=%d)", m, m.ErrorCode)
}
...
func (m *LobbySessionFailurev2) String() string {
	return fmt.Sprintf("%T(channel_uuid=%s, error_code=%d)", m, m.ChannelUUID.String(), m.ErrorCode)
}
...
func (m *LobbySessionFailurev3) String() string {
	return fmt.Sprintf("%T(game_type=%d, channel=%s, error_code=%d, unk0=%d)", m, m.GameTypeSymbol, m.ChannelUUID.String(), m.ErrorCode, m.Unk0)
}
