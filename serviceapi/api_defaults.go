...
const (
	...
	DefaultClientConfig_ActiveBattlePassSeason string = `{
	...
	DefaultClientConfig_ActiveStoreEntry string = `{
			"entry_number": 0,
			"marketing": {
	...
	DefaultClientConfig_ActiveStoreFeaturedEntry string = `{
			"entry_number": 0,
			"marketing": {
				"menu_store_panel_start_texture": "ui_menu_splash_screen_poster_a_shutdown_clr",
				"menu_store_panel_upsell_texture": "ui_menu_splash_screen_poster_a_shutdown_clr",
