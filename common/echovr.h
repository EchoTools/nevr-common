...
/// <summary>
/// TODO: Allocator structure, used to track heap allocations and provide game plugin modules the ability to use a
/// standardized heap.
/// </summary>
struct Allocator {};
...
struct BroadcasterData {
  ...
  CHAR _unk0[0xE8 + (0xE8 - sizeof(broadcastSocketInfo))];  // TODO: BroadcastSocketInfo is around 0xE8 in size. Then we
                                                            // have 0xE8 of unknown data.
...
class TcpBroadcasterData {
 ...
 public:
  ...
  virtual VOID __Unknown2() = 0;  // TODO: This was put here to shift vtable to allow CreatePeer/SendToPeer to work.
                                  // Maybe the shift is higher?
